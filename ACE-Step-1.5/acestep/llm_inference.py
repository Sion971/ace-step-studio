    ...
    def unload(self) -> None:
        ...
        try:
            if self.llm_backend == "vllm":
                try:
                    # Our fix: prefer exit() over reset() for vLLM, otherwise
                    # CUDA graphs and KV cache stay pinned in VRAM.
            ...
            # Explicitly delete to break reference cycles before gc.collect() — RAM leak fix
            old_llm = self.llm
