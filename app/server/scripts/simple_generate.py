...
def get_handlers(config_path="acestep-v15-xl-turbo"):
...
def generate(
    ...
    handler, llm_handler = get_handlers(config_path=config_path)
...
def main():
    ...
    # Model selection
    parser.add_argument("--config-path", type=str, default="acestep-v15-xl-turbo", help="Model config path (e.g., acestep-v15-xl-turbo)")
