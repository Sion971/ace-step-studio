                                            ...
                                            <div className="min-w-0">
                                                <div className="text-xs text-zinc-500">
                                                    ...
                                                    <span className="ml-1 text-zinc-400">
                                                        · {t('audioCoverStrength') || 'influence'} {Math.round((song.generationParams?.audioCoverStrength ?? 1) * 100)}%
                                                        {song.generationParams?.taskType === 'repaint' && (
                                                            <>
                                                                {song.generationParams?.repaintStrength !== undefined && ` · ${t('strength') || 'force'} ${Math.round((song.generationParams.repaintStrength ?? 0.5) * 100)}%`}
